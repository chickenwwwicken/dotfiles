...
vim.keymap.set('v', '<leader>mt', [[c***<c-r>"***<esc>]], { desc = 'wrap around italic bold' })
vim.keymap.set('v', '<leader>mbt', [[c`<c-r>"`<esc>]], { desc = 'wrap around backticks' })
